...
_steps = [
    ...
    # this, then you need to run this step explicitly
...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "train_random_forest" in active_steps:
            ...
            # NOTE: we need to serialize the
            # random forest configuration into JSON
            ...
            # NOTE: use the rf_config we just created as
            # the rf_config parameter for the train_random_forest
            # step
