...
def test_row_count(data: pd.DataFrame):
    """
    Apply test about row count, which checks that the size
    of the dataset is reasonable (not too small, not too large
    """
...
def test_price_range(data: pd.DataFrame, min_price: float, max_price: float):
    """
    Apply test about prices which checks that range in
    min_price and max_price if it is ok
    """
